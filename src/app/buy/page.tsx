...
export const metadata: Metadata = {
  title: '《2026专业报考完整指南》—— 244个专业数据 + AI分析 | 专业就业通',
  description: '基于教育部公开数据+招聘平台大数据+AI风险模型，244个专业全覆盖。含薪资趋势、就业率、AI替代风险、院校推荐。关注公众号免费领试读版。',
};
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
      ...
      <div className="flex flex-wrap justify-center gap-4 sm:gap-8 mb-10 text-center">
        <div>
          <div className="text-2xl font-bold text-blue-600">244</div>
      ...
      {/* 双入口：公众号（免费）+ 微信（付费） */}
      <div id="how-to-buy" className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
        {/* 公众号入口 — 免费 */}
        <div className="bg-gradient-to-br from-green-50 to-emerald-50 border-2 border-green-200 rounded-2xl p-6 sm:p-8 text-center">
          <div className="inline-block bg-green-500 text-white text-xs font-bold px-3 py-1 rounded-full mb-4">免费</div>
          <h2 className="text-xl font-bold text-gray-900 mb-2">📱 关注公众号 · 领免费试读版</h2>
          <p className="text-sm text-gray-600 mb-5">
            扫码关注后回复「<strong className="text-green-700">报考指南</strong>」自动领取
          </p>
          {/* OA QR Code */}
          <div className="bg-white rounded-xl p-4 inline-block mb-3 border border-green-100">
            <img
              src="/images/oa-qrcode.png"
              alt="关注公众号领取免费报考指南"
        ...
        {/* 微信入口 — 付费 */}
        <div className="bg-gradient-to-br from-blue-50 to-indigo-50 border-2 border-blue-200 rounded-2xl p-6 sm:p-8 text-center">
          <div className="inline-block bg-blue-600 text-white text-xs font-bold px-3 py-1 rounded-full mb-4">¥49 完整版</div>
          <h2 className="text-xl font-bold text-gray-900 mb-2">💬 加微信 · 购买完整版</h2>
          <p className="text-sm text-gray-600 mb-2">
            微信转账 ¥49，发你244个专业完整数据PDF
          </p>
          <p className="text-xs text-gray-400 mb-5">
            备注「<strong className="text-blue-700">完整版</strong>」，工作日2小时内发货
          </p>
          {/* 购买流程简图 */}
          <div className="flex items-center justify-center gap-2 sm:gap-3 mb-5 text-xs text-gray-500">
            <span className="bg-white px-2 py-1 rounded border">加微信</span>
            <span>→</span>
            <span className="bg-white px-2 py-1 rounded border">转账¥49</span>
            <span>→</span>
            <span className="bg-white px-2 py-1 rounded border">发截图</span>
            <span>→</span>
      ...
      <section className="bg-white border border-gray-200 rounded-2xl p-6 sm:p-8 mb-10">
        ...
        <div className="space-y-4 text-sm text-gray-700 leading-relaxed">
          ...
          <p>
            <strong>AI评估模型有依据。</strong>AI替代风险的评估基于我们自研的任务可自动化程度模型，综合考量了：重复性任务占比、创造性工作占比、人际互动复杂度、法规/伦理屏障等维度。
          </p>
          <p>
            <strong>不是报志愿机构。</strong>我们不做填报服务、不推荐具体学校、不收取任何咨询服务费。这份指南是数据整理和分析的结果，目的是让你有更全面的信息做决定。
          </p>
        </div>
      </section>
      ...
      <div className="text-center bg-gradient-to-r from-blue-600 to-indigo-600 rounded-2xl p-8 text-white">
        ...
        <p className="text-blue-100 mb-5 text-sm sm:text-base">高考志愿只有一次，244个专业的完整数据帮你做更明智的选择</p>
        <a
          href="#how-to-buy"
